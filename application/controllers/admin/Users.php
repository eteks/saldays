		...
		if(!empty($_POST))
		{
			...
			$validation_rules = array(
		       array(
		             ...
		             'label'   => 'Username',
		             'rules'   => 'trim|required|min_length[5]|max_length[12]|is_unique[saai_adminusers.adminuser_id.adminuser_username.'.$id.']'
		          ),
		       array(
					 ...
					 $data['result']=$result;
					  $message = $this->load->view('admin/register_confirmation',$data,TRUE);     
						...
						if($this->email->send())
						{
							...
							$data['error_message'] = "Leader Added Successfully!";
